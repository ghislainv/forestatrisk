...
def test_model_binomial_icar(gstart):
    ...
    pred_icar = np.array([0.34388896, 0.29002158, 0.51594223,
                          0.48436339, 0.60838453, 0.61257058, 0.55034979,
                          0.58819568, 0.51087469, 0.58819568, 0.64149789,
                          0.57400436, 0.59570952, 0.63212285, 0.566676,
                          0.62562204, 0.55379459, 0.15644965, 0.61284327,
                          0.36638686, 0.55439297, 0.57325744, 0.62562204,
                          0.17995823, 0.4930868, 0.54641479, 0.59782004,
                          0.48159526, 0.62882886, 0.59831051, 0.76245777,
                          0.74576097, 0.77356767, 0.73863295, 0.78188891,
                          0.75056545, 0.60775752, 0.64978574, 0.74654465,
                          0.77378323, 0.53994416, 0.75852715, 0.77754366,
                          0.60053684, 0.71543739, 0.74565542, 0.7555028,
                          0.44598923, 0.76401273, 0.75953027, 0.49027142,
                          0.69610182, 0.75679461, 0.78543649, 0.76863321,
                          0.6209473, 0.77653139, 0.76182804, 0.78169681,
                          0.58816002, 0.50453473, 0.77980428, 0.76084413,
                          0.73054832, 0.78289747, 0.71858934, 0.78362842,
                          0.74702923, 0.67357571, 0.78940242, 0.75358937,
                          0.66791346, 0.75602843, 0.42494845, 0.77653139,
                          0.60509306, 0.60846943, 0.76187008, 0.73278992,
                          0.72792572, 0.47661681, 0.59456417, 0.71894598,
                          0.6731302, 0.74964489, 0.77247818, 0.78289747,
                          0.74200682, 0.78940242, 0.78508877, 0.73153419,
                          0.65636031, 0.78607775, 0.59738545, 0.72596162,
                          0.78216462, 0.75078253, 0.77527468, 0.69907386,
                          0.71991522])

    assert np.allclose(gstart["pred_icar"][0:100], pred_icar)


def test_rho(gstart):
    """Test rho."""

    rho = np.array([-3.72569484e-02, -1.16871478e-01, -1.82400711e-01,
                    ...
                    1.47482553e00, 1.45848019e00, 4.05321503e-01,
                    1.06327906e00, 4.37780456e-01, -1.12202021e-01,
                    -7.22139489e-01, -7.33312519e-01, -6.68442058e-01,
                    -7.76218335e-01, -8.02763852e-01, 1.41620727e00,
                    1.56564133e00, 1.24252305e00, 9.07095194e-01,
                    4.38959947e-01, -2.95546782e-01, -4.92024764e-01,
                    -9.62965263e-01, -8.93107795e-01, -9.80673724e-01,
                    -9.94878624e-01, 1.41460696e00, 1.38942057e00,
                    1.97092977e00, 1.06797639e00, 4.36803818e-01,
